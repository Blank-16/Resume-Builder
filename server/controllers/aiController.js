...
export const enhanceProfessionalSummary = async (req, res) => {
    try {
        ...
        const systemPrompt = "You are an expert in resume writing. Your task is to enhance the professional summary of the resume. The summary should be 1-2 sentences also highlighting key skills, experience, and carrer objectives. Make it compelling and ATS friendly also return text no option or anything else."
