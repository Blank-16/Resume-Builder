...
const Dashboard = () => {
  ...
  // for popup of create Resume
  const [showCreateResume, setShowCreateResume] = useState(false)

  // for popup of uploading resume 
  ...
  const createResume = async (event) => {
    ...
    // giving dummy id res123 for now
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <p className="text-2xl font-medium mb-6 bg-linear-to-r from-slate-600 to slate-700 bg-clip-text text-transparent sm:hidden">Welcome John Doe</p>
        ...
        {allResumes.map((resume, index) => {
          ...
          return (
            ...
            >
              ...
              <p className="absolute bottom-1 text-[11px] text-slate-400 group-hover:text-slate-500 transition-all duration300 px-2 text-center"
                style={{ color: baseColor + '90' }}
              >
                Updaded On {new Date(resume.updatedAt).toLocaleDateString()}
              </p>
              ...
              ">
                ...
                <TrashIcon
                  ...
                  className='size-7 p-1.5 hover:bg-white/50 rounded text-sm' />
      ...
      <div className="">
        ...
        {/* Showing the create Resume popup */}
        {showCreateResume && (
          <form
            ...
            className='fixed inset-0 bg-black/70 backdrop-blur-2xl backdrop-opacity-50 z-10 flex items-center justify-center '>
            <div
              onClick={e => e.stopPropagation()}
              ...
              <XIcon className='absolute top-4 right-4 text-slate-700 hover:text-slate-600 cursor-pointer'
                onClick={() => {
                  setShowCreateResume(false);
                  setTitle('')
                }}
        ...
        {/* Showing the Upload Resume popup */}
        {showUploadResume && (
          <form
                ...
                <label htmlFor="resume-input" className='block text-sm text-slate-700'>
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 border group text-slate-400 border-slate-400 border-dashed rounded-md p-4 py-10 my-4 hover:border-green-500 hover:text-green-700 cursor-pointer transition-colors">
                    {resume ? (
                      ...
                      <>
                        <UploadCloud className='size-1/4 stroke-1' />
                        <p>Upload Resume</p>
                      </>
                    )}
                  </div>
        ...
        {/* Popup for changing Resume Title */}
        {editResumeId && (
          <form
            onSubmit={editTitle}
            onClick={() => {
