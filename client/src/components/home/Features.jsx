...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Tittle title={`Build your Resume`} description={`Build your future carrer by creating a professional resume in minutes with intelligent AI-powered tools and features.`} />
