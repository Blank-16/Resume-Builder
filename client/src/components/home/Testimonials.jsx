...
const Testimonials = () => {
    return (
        ...
        <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Tittle title={`Don't just take our words`} description={`Hear what our users say about us. We're always looking for ways to improve. Please share your experiece with us, leave a review.`} />
