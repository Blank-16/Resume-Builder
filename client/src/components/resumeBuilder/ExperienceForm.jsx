...
import { Briefcase, Compass, Loader2, Plus, Sparkle, Sparkles, Trash2 } from 'lucide-react'
...
const ExperienceForm = ({ data, onChange }) => {
    ...
    const updateExperience = (index, field, value) => {
        ...
        // performing a non desctructive update of a specific object inside an array, creating a brand new object with updated information and placing it into the array at the specific index. 
        // to explicitly state react that a change has happened since we are not mutating the old object we are creating a new copy that has one change and hence hinting react that a change has happened and it needs to be rerendered 
