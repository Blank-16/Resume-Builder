...
const ColorPicker = ({ selectedColor, onChange }) => {
    ...
    return (
        <div className="relative" ref={containerRef}>
            ...
            {isOpen && (
                <div
                    className='grid grid-cols-4 w-60 gap-2 absolute top-full left-0 right0 p-3 mt-2 z-10 bg-white rounded-md border border-gray-200 shadow-sm'
                >
                    {colors.map((color) => (
                        <div
                            key={color.value}
                        ...
                        >
                            ...
                            {selectedColor === color.value && (
                                <div
                                    className='absolute top-0 bottom-4 right-0 left-0 flex items-center justify-center'
                                >
